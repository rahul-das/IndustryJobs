...
class InterviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post interviews_url, params: { interview: { date: @interview.date, job_application_id: @interview.job_application_id, time: @interview.time } }
    end
  ...
  test "should update interview" do
    patch interview_url(@interview), params: { interview: { date: @interview.date, job_application_id: @interview.job_application_id, time: @interview.time } }
